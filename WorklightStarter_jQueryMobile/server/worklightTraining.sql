...
MySQL - 5.1.46-community : Database - worklight_training
*********************************************************************
*/
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`worklight_training` /*!40100 DEFAULT CHARACTER SET latin1 */;

USE `worklight_training`;
...
/*!50003 CREATE DEFINER=`Worklight`@`localhost` PROCEDURE `getAccountTransactions`(in accountId varchar(15))
BEGIN
